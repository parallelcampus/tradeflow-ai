    ...
    <section className="py-24 bg-foreground relative overflow-hidden">
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-serif font-bold text-background mb-6 leading-tight">
          ...
          <div className="grid sm:grid-cols-3 gap-8 pt-8 border-t border-background/10">
            <div className="flex flex-col items-center gap-2">
              <Globe className="w-8 h-8 text-primary" />
              <span className="text-background font-semibold">150+ Countries</span>
              <span className="text-sm text-background/60">Global reach</span>
            </div>
            <div className="flex flex-col items-center gap-2">
              <Users className="w-8 h-8 text-primary" />
              <span className="text-background font-semibold">50,000+ Users</span>
              <span className="text-sm text-background/60">Active community</span>
            </div>
            <div className="flex flex-col items-center gap-2">
              <Sparkles className="w-8 h-8 text-primary" />
              <span className="text-background font-semibold">24/7 AI Support</span>
              <span className="text-sm text-background/60">Always available</span>
            </div>
          </div>
        </div>
      </div>
