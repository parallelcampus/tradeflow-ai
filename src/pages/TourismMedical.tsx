          ...
          <div className="container mx-auto px-4 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-lg text-background/70 max-w-3xl mx-auto leading-relaxed">
                AITAS facilitates international patients and pilgrims by connecting them to accredited hospitals, healthcare specialists, and religious tourism circuits in India and other partner countries. The program supports visa guidance, medical coordination, travel support, and post-treatment services.
              </p>
            </div>
          </div>
        </section>
              ...
              <Card className="border border-primary/20 max-w-2xl">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div>
                    ...
                    <Textarea placeholder="Describe the pilgrimage circuit or sites you're interested in" className="rounded-sm" />
                  </div>
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      <label className="text-sm font-medium text-foreground mb-1.5 block">Group Size</label>
                      <Input type="number" placeholder="Number of travelers" className="rounded-sm" />
                    </div>
                    <div>
                      <label className="text-sm font-medium text-foreground mb-1.5 block">Preferred Dates</label>
                      <Input type="text" placeholder="e.g., March 2026" className="rounded-sm" />
                    </div>
                  </div>
                  <div>
                    <label className="text-sm font-medium text-foreground mb-1.5 block">Contact Email *</label>
